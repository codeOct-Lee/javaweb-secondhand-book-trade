...
<%--                                <img src="${pageContext.request.contextPath}/yanzhengma/index.do" alt="验证码" height="50px" width="50%" id="isyzm" onclick="updateUseryanzhengma();">&nbsp;&nbsp;--%>
                                <a href="${pageContext.request.contextPath}/page/register.jsp" style="font-size: 25px" >没有账户,点此注册</a>
