                ...
                <div class="cart-page-container fix">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="shopping-cart">
                            <div class="cart-page-title text-center"><h1>确认订单</h1></div>
                            <form action="${pageContext.request.contextPath}/order/addOrder.do" id="cart-form" method="post">
                                <input type="hidden" name="pid" value="${confirmproduct.id}">
                                <input type="hidden" name="uid" value="${confirmproduct.user_id}">
                                <div class="table-responsive">
                                    <fieldset>
                                        <table class="table-cart data-table table" id="shopping-cart-table">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#" class="cart-image"><img src="${pageContext.request.contextPath}/product/${confirmproduct.image}" alt="" /></a>

                                                <td><span class="cart-price">${confirmproduct.name}</span></td>
                                                <!-- inclusive price starts here -->
                                                <td><span class="cart-price">￥${confirmproduct.price}</span></td>
