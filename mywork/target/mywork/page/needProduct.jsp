                ...
                <div class="pro-info-tab-container-2 fix">
                    ...
                    <div class="tab-content fix">
                        ...
                        <div class="pro-rev-form fix">
                            <h2>发布求购信息</h2>
                            <form action="${pageContext.request.contextPath}/needs/pubNeedProduct.do" id="rev-form" class="moon-form">

                                <div class="input-box">
                                    <textarea name="nmessage" id="rev-message" placeholder="Message" rows="5"></textarea>
                                </div>
                                <div class="input-box">
