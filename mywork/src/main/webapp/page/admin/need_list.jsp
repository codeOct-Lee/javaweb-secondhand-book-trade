        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="need" items="${needs}">
                <tr class="text-c">
                    ...
                    <td>${need.nid}</td>
                    <td>${need.user.username}</td>
                    <td>${need.nmessage}</td>
                    <td>${need.pubdate}</td>
                    <td class="f-14 td-manage"> <a style="text-decoration:none"  href="${pageContext.request.contextPath}/user/selectUserbyid.do?uid=${user.user_id}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none"  href="${pageContext.request.contextPath}/needs/deletNeed.do?nid=${need.nid}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
